...
function hackeryou_widgets_init() {
	...
	//new social menu sidebar
		register_sidebar( array(
		'name' => 'social-menu-sidebar',
		'id' => 'social-menu-sidebar',
		'description' => 'The social menu sidebar',
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
function hackeryou_posted_in() {
	...
	if ( $tag_list ) {
		...
		$posted_in = 'Categories: %1$s. <br>Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.';
	} else {
